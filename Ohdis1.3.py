...
authenticator = IAMAuthenticator("Your IBM Watson Text to Speech API Key")
text_to_speech = TextToSpeechV1(
    authenticator=authenticator
)

text_to_speech.set_service_url(
    'Your IBM Watson Text to Speech URL')
        ...
        if assistname in takeCommand().lower():
            ...
            if "open youtube" in query:
                ...
                with open('Ohdis_voice.wav', 'wb') as audio_file:
                    audio_file.write(
                        text_to_speech.synthesize(
                            "I have been created by Edgar Technologies",
                            voice=OhdisVoice,
                            accept='audio/wav'
                        ).get_result().content)
                    vlc_instance = vlc.Instance()
            ...
            elif "Import selected data from Edgar Secure Servers" in query:
                with open('Ohdis_voice.wav', 'wb') as audio_file:
                    audio_file.write(
                        text_to_speech.synthesize(
                            "I wasn't able to connect to Edgar Servers. Please update my abilities",
                            voice=OhdisVoice,
                            accept='audio/wav'
                        ).get_result().content)
                    vlc_instance = vlc.Instance()
                ...
                with open('Ohdis_voice.wav', 'wb') as audio_file:
                    audio_file.write(
                        text_to_speech.synthesize(
                            "I was created as an all purpose assistant for Edgar",
                            voice=OhdisVoice,
                            accept='audio/wav'
                        ).get_result().content)
                    vlc_instance = vlc.Instance()
            ...
            elif "update assistant from Edgar Web Servers" in query:
                with open('Ohdis_voice.wav', 'wb') as audio_file:
                    audio_file.write(
                        text_to_speech.synthesize(
